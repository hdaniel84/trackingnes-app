...
import TrackingFornoEntradaForm from '@/components/forms/fornoEntrada/TrackingFornoEntradaForm.vue';
                    ...
                    <div class="p-2 rounded-lg" :class="press.color">
                        <div class="mb-3 ml-2">
                            <h4 class="text-2xl font-bold text-surface-900 dark:text-surface-0">
                                <i class="pi pi-gauge mr-2" style="font-size: 2rem"></i>
                                Forno - ({{ press.name }})
                            </h4>
                        </div>

                        <TrackingFornoEntradaForm :pressName="press.name" />
                    </div>
                </TabPanel>
            </TabPanels>
        </Tabs>
