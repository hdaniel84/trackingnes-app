    ...
    <Dialog :visible="props.visible" @update:visible="emit('update:visible', $event)" modal
        ...
        <div v-if="props.item" class="space-y-2">
            ...
            <div class="grid grid-cols-2 gap-2">
                ...
                <div class="p-2 border rounded-lg">
                    <p class="text-xs text-surface-400">Fim</p>
                    <p class="font-medium">{{ formatDateTime(props.item.endTime) }}</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-2 gap-2">
                <div class="p-2 border rounded-lg">
                    <p class="text-xs text-surface-400">Equipamento</p>
                    <p class="font-medium">{{ props.item.equipmentDescription }}</p>
                </div>
                <div class="p-2 border rounded-lg">
                    <p class="text-xs text-surface-400">Seção</p>
                    <p class="font-medium">{{ props.item.teamSectionDescription }}</p>
                </div>
                <div class="p-2 border rounded-lg">
                ...
                <div class="p-2 border rounded-lg">
                    <p class="text-xs text-surface-400">Matéria Prima</p>
                    <p class="font-medium">{{ props.item.rawMaterialDescription }}</p>
                </div>
                <div class="p-2 border rounded-lg">
                    <p class="text-xs text-surface-400">Lote</p>
                    <p class="font-medium">{{ props.item.lote }}</p>
                </div>
                <div class="p-2 border rounded-lg col-span-2">
