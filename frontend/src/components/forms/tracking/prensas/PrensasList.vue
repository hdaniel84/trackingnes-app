...
import PrensasEditDialog from './PrensasEditDialog.vue'; 
import PrensasDetailDialog from './PrensasDetailDialog.vue'; 
...
<template>
  <div class="w-full">
    ...
    <PrensasEditDialog v-model:visible="showEditDialog" :item="selectedItem" />
    <PrensasDetailDialog v-model:visible="showDetailDialog" :item="selectedItem" />
  </div>
</template>